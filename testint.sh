...
CASE=9
# Outside matching external network
echo "Sending packets with IP matching external network via $SPOOFED_ADDR: "
hping3 $IP -S -c 5 -p 80 -a $SPOOFED_ADDR > $BASEFILE$CASE
